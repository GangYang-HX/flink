...
public class StreamTaskTimerITCase extends AbstractTestBase {
	...
	public void testOperatorChainedToSource() throws Exception {
		...
		source.transform("Custom Operator", "Custom Operator", BasicTypeInfo.STRING_TYPE_INFO, new TimerOperator(ChainingStrategy.ALWAYS));
	...
	public void testOneInputOperatorWithoutChaining() throws Exception {
		...
		source.transform("Custom Operator", "Custom Operator", BasicTypeInfo.STRING_TYPE_INFO, new TimerOperator(ChainingStrategy.NEVER));
