...
public class NotifyCheckpointAbortedITCase extends TestLogger {
	...
	public void testNotifyCheckpointAborted() throws Exception {
		...
		env.addSource(new NormalSource()).name("NormalSource")
			...
			.transform("NormalMap", "NormalMap", TypeInformation.of(Integer.class), new NormalMap())
			.transform(DECLINE_SINK_NAME, DECLINE_SINK_NAME, TypeInformation.of(Object.class), new DeclineSink());
