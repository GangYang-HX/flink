...
public class TimestampITCase extends TestLogger {
	...
	public void testWatermarkPropagation() throws Exception {
		...
		source1.union(source2)
				...
				.transform("Custom Operator", "Custom Operator", BasicTypeInfo.INT_TYPE_INFO, new CustomOperator(true))
	...
	public void testTimestampHandling() throws Exception {
		...
		source1
				.map(new IdentityMap())
				.connect(source2).map(new IdentityCoMap())
				.transform("Custom Operator", "Custom Operator", BasicTypeInfo.INT_TYPE_INFO, new TimestampCheckingOperator())
				.addSink(new DiscardingSink<Integer>());
	...
	public void testDisabledTimestamps() throws Exception {
		...
		source1
				.map(new IdentityMap())
				.connect(source2).map(new IdentityCoMap())
				.transform("Custom Operator", "Custom Operator", BasicTypeInfo.INT_TYPE_INFO, new DisabledTimestampCheckingOperator())
				.addSink(new DiscardingSink<Integer>());
