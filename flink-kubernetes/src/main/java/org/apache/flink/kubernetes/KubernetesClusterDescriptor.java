...
public class KubernetesClusterDescriptor implements ClusterDescriptor<String> {
	...
	private ClusterClientProvider<String> deployClusterInternal(
		...
		flinkConfig.setDouble(JobManagerOptions.JOBMANAGER_VCORES, flinkConfig.getDouble(KubernetesConfigOptions.JOB_MANAGER_CPU));
		flinkConfig.setDouble(
				TaskManagerOptions.TASKMANAGER_VCORES,
				flinkConfig.getDouble(KubernetesConfigOptions.TASK_MANAGER_CPU, clusterSpecification.getSlotsPerTaskManager()));
