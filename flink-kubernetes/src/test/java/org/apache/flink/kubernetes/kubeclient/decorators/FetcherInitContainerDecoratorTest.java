...
public class FetcherInitContainerDecoratorTest extends KubernetesJobManagerTestBase {

    private FetcherInitContainerDecorator fetcherInitContainerDecorator;

    @Override
    protected void onSetup() throws Exception {
        super.onSetup();

        this.fetcherInitContainerDecorator =
                new FetcherInitContainerDecorator(kubernetesJobManagerParameters);
    }
    ...
    public void testContainerIsDecorated() {
        ...
        final FlinkPod resultFlinkPod =
                fetcherInitContainerDecorator.decorateFlinkPod(baseFlinkPod);
        assertThat(
