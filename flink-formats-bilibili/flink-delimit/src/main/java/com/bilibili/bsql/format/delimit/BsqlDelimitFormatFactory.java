...
import static com.bilibili.bsql.format.delimit.BsqlDelimitConfig.SINK_SERIALIZER;
...
public final class BsqlDelimitFormatFactory
                ...
                if (useLancerFormat) {
                    if (FORMAT_BYTES.equals(format)) {
                        ...
                        return new LancerCustomDelimiterRawDeserialization(
                                rowDataTypeInfo, rowType, delimitString, useLancerDebug);
                    }
                }
    ...
    public EncodingFormat<SerializationSchema<RowData>> createEncodingFormat(
        ...
        validateFormatOptions(formatOptions);
        String delimitString = unicodeStringDecode(formatOptions.get(DELIMITER_KEY));
        String serializer = formatOptions.get(SINK_SERIALIZER);
        ...
        return new EncodingFormat<SerializationSchema<RowData>>() {
            ...
            public SerializationSchema<RowData> createRuntimeEncoder(
                ...
                if (FORMAT_BYTES.equals(serializer)) {
                    return new CustomDelimitBytesSerialization(rowType, converter, rowDataTypeInfo);
                }
                return new CustomDelimiterSerialization(
                        rowType, converter, rowDataTypeInfo, delimitString);
            }
