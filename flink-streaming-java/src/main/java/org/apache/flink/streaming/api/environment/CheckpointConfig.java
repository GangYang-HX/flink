...
public class CheckpointConfig implements java.io.Serializable {
	...
	/**
	 * Determines the threshold that we tolerate declined checkpoint failure number.
	...
	public void setSkipMaxParallelismCheck(boolean skip) {
		this.skipMaxParallelismCheck = skip;
	}
	...
	public boolean shouldSkipMaxParallelismCheck() {
	...
	public void enableRegionalCheckpoint(boolean enabled) {
		regionalCheckpointEnabled = enabled;
	}
	...
	public void setMaxTolerableConsecutiveFailuresOrExpirations(int max) {
		maxTolerableConsecutiveFailuresOrExpirations = max;
	}
	...
	public void setMaxTolerableFailureOrExpirationRatio(double max) {
		maxTolerableFailureOrExpirationRatio = max;
	}
	...
	public void setExcludeBroadcastedVertex(boolean excludeBroadcastedVertex) {
		this.excludeBroadcastedVertex = excludeBroadcastedVertex;
	}

	public boolean getExcludeBroadcastedVertex() {
		return this.excludeBroadcastedVertex;
	}
	...
	public void configure(ReadableConfig configuration) {
		...
		configuration.getOptional(ExecutionCheckpointingOptions.ENABLE_CHECKPOINT_INFO_LISTENER)
			.ifPresent(this::enableCheckpointInfoListener);
		configuration.getOptional(ExecutionCheckpointingOptions.ENABLE_REGIONAL_CHECKPOINT)
				.ifPresent(this::enableRegionalCheckpoint);
		configuration.getOptional(ExecutionCheckpointingOptions.SKIP_MAX_PARALLELISM_CHECK)
			.ifPresent(this::setSkipMaxParallelismCheck);
		configuration.getOptional(ExecutionCheckpointingOptions.AUTO_ADJUST_MAX_PARALLELISM)
			.ifPresent(this::enableAutoAdjustMaxParallelism);
		configuration.getOptional(ExecutionCheckpointingOptions.MAX_TOLERABLE_CONSECUTIVE_FAILURES_OR_EXPIRATIONS)
				.ifPresent(this::setMaxTolerableConsecutiveFailuresOrExpirations);
		configuration.getOptional(ExecutionCheckpointingOptions.MAX_TOLERABLE_FAILURE_OR_EXPIRATION_RATIO)
				.ifPresent(this::setMaxTolerableFailureOrExpirationRatio);
		configuration.getOptional(ExecutionCheckpointingOptions.EXCLUDE_BROADCASTED_VERTEX)
				.ifPresent(this::setExcludeBroadcastedVertex);
