...
public class OutputFileConfig implements Serializable {
	...
	private boolean useTimestampFilePrefix;
	...
	public OutputFileConfig(final String partPrefix, final String partSuffix) {
		...
		this.useTimestampFilePrefix = false;
	}

	public OutputFileConfig(final String partPrefix, final String partSuffix, final boolean useTimestampFilePrefix) {
		this.partPrefix = Preconditions.checkNotNull(partPrefix);
		this.partSuffix = Preconditions.checkNotNull(partSuffix);
		this.useTimestampFilePrefix = Preconditions.checkNotNull(useTimestampFilePrefix);
	}
	...
	public String getPartPrefix() {
		if (useTimestampFilePrefix) {
			return partPrefix + "-" + System.currentTimeMillis();
		} else {
			return partPrefix;
		}
	...
	public static class OutputFileConfigBuilder {
		...
		public OutputFileConfigBuilder useTimestampFilePrefix(boolean useTimestampFilePrefix) {
			this.useTimestampFilePrefix = useTimestampFilePrefix;
			return this;
		}
		...
		public OutputFileConfig build() {
			return new OutputFileConfig(partPrefix, partSuffix, useTimestampFilePrefix);
		}
	}
}
