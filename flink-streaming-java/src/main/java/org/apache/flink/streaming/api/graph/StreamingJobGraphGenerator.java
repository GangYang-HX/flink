        ...
        for (Integer sourceNodeId : streamGraph.getSourceIDs()) {
            ...
            if (sourceNode.getOperatorFactory() instanceof SourceOperatorFactory
                ...
                if (targetChainingStrategy == ChainingStrategy.HEAD_WITH_SOURCES
                    ...
                    operatorConfig.setOperatorDescription(sourceNode.getOperatorDescription());
                    chainedSources.put(
    ...
    private List<StreamEdge> createChain(
        ...
        if (!builtVertices.contains(startNodeId)) {
            ...
            if (currentNodeId.equals(startNodeId)) {
                ...
                config.setOperatorDescription(
                        streamGraph.getStreamNode(currentNodeId).getOperatorDescription());
                ...
                config.setOperatorDescription(node.getOperatorDescription());
        ...
        Map<OperatorID, String> operatorDescriptions =
                vertexConfigs.values().stream()
                        .collect(
                                Collectors.toMap(
                                        StreamConfig::getOperatorID,
                                        StreamConfig::getOriginalOperatorDescription));
        ...
        JobCheckpointingSettings settings =
                new JobCheckpointingSettings(
                        CheckpointCoordinatorConfiguration.builder()
                                ...
                                .enableAutoAdjustMaxParallelism(
                                        cfg.autoAdjustMaxParallelismEnable())
                                ...
                                .setCheckpointInfoListenerEnabled(
                                        cfg.isCheckpointInfoListenerEnabled())
