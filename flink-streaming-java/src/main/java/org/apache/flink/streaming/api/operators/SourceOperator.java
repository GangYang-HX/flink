...
public class SourceOperator<OUT, SplitT extends SourceSplit>
	...
	public void notifyCheckpointComplete(long checkpointId) throws Exception {
		...
		LOG.info("sourceReader: {}", sourceReader);
		if (sourceReader instanceof CheckpointListener) {
			((CheckpointListener) sourceReader).notifyCheckpointComplete(checkpointId);
		}
	}
	...
	public void notifyCheckpointAborted(long checkpointId) throws Exception {
		...
		if (sourceReader instanceof CheckpointListener) {
			((CheckpointListener) sourceReader).notifyCheckpointAborted(checkpointId);
		}
	}
