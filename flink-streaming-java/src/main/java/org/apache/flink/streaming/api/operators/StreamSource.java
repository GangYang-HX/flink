...
import static org.apache.flink.configuration.bili.SourceOptions.KAFKA_IDLE_INTERVAL;
...
public class StreamSource<OUT, SRC extends SourceFunction<OUT>> extends AbstractUdfStreamOperator<OUT, SRC> {
	...
	public void run(final Object lockingObject,
		...
		final long idleDetectionInterval = configuration.getLong(KAFKA_IDLE_INTERVAL);
		LOG.info("kafka idle detection timeout {}", idleDetectionInterval);
