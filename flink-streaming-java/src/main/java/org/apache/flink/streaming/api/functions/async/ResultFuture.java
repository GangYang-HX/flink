...
public interface ResultFuture<OUT> {
	...
	/**
	 * Completes the result future exceptionally with retry.
	 *
	 * @param result
	 */
	default void completeOrRetry(Collection<OUT> result) {
		throw new UnsupportedOperationException("default implement is not support");
	}
}
