...
/** Tests for {@link StreamGraphHasherV3}. */
public class StreamGraphHasherV3Test {
    ...
    public void testHashTwice() {
        ...
        Map<Integer, byte[]> hashes =
                generateHashes(envAndTransformations.f0, envAndTransformations.f1);

        Tuple2<StreamExecutionEnvironment, List<Transformation<?>>> secondEnvAndTransformations =
                generateTransformations(true);

        Map<Integer, byte[]> secondHashes =
                generateHashes(secondEnvAndTransformations.f0, secondEnvAndTransformations.f1);
    ...
    private Map<Integer, byte[]> generateHashes(
            StreamExecutionEnvironment streamEnv, List<Transformation<?>> transformations) {
