...
public class StreamTaskMailboxTestHarnessBuilder<OUT> {
	...
	public StreamTaskMailboxTestHarnessBuilder<OUT> setThroughputCalculator(
	...
	public StreamTaskMailboxTestHarnessBuilder<OUT> modifyStreamConfig(Consumer<StreamConfig> configuration) {
		configuration.accept(this.streamConfig);
