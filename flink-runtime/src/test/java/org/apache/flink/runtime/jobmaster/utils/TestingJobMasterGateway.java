...
public class TestingJobMasterGateway implements JobMasterGateway {
	...
	@Nonnull
	private final BiConsumer<ResourceID, TaskExecutorHeartbeatPayloadForJobMaster> taskManagerHeartbeatConsumer;
	...
	@Nonnull
	private final Supplier<CompletableFuture<Long>> triggerFullCheckpointSupplier;
	...
	@Nonnull
	private final Consumer<AcknowledgeTriggerSnapshot> acknowledgeTriggerSnapshotConsumer;
	...
	public TestingJobMasterGateway(
			...
			@Nonnull BiConsumer<ResourceID, TaskExecutorHeartbeatPayloadForJobMaster> taskManagerHeartbeatConsumer,
			...
			@Nonnull Supplier<CompletableFuture<Long>> triggerFullCheckpointSupplier,
			...
			@Nonnull Consumer<AcknowledgeTriggerSnapshot> acknowledgeTriggerSnapshotConsumer,
		...
		this.triggerFullCheckpointSupplier = triggerFullCheckpointSupplier;
		...
		this.acknowledgeTriggerSnapshotConsumer = acknowledgeTriggerSnapshotConsumer;
	...
	@Override
	public void heartbeatFromTaskManager(ResourceID resourceID, TaskExecutorHeartbeatPayloadForJobMaster payload) {
	...
	public void reportSpeculativeTaskOptions(SpeculativeTasksOptions options) {
		throw new UnsupportedOperationException("It does not support speculative task manager.");
	}

	@Override
	public CompletableFuture<Acknowledge> reportSpeculativeTaskTimeCost(
			SpeculativeTaskTimeCosts timeCosts) {
		throw new UnsupportedOperationException("It does not support speculative task manager.");
	}
	...
	public CompletableFuture<Long> triggerFullCheckpoint(final Time timeout, final boolean incremental,
		...
		return this.triggerFullCheckpointSupplier.get();
	}
	...
	public void acknowledgeTriggerSnapshot(AcknowledgeTriggerSnapshot acknowledgeTriggerSnapshot) {
		acknowledgeTriggerSnapshotConsumer.accept(acknowledgeTriggerSnapshot);
	}
