...
public class TestingTaskExecutorGateway implements TaskExecutorGateway {
	...
	private final Consumer<Collection<ThresholdNotification>> notifySpeculativeThresholdsConsumer;
	...
	@Override
	public CompletableFuture<Acknowledge> notifySpeculativeThresholds(
			JobID jobID,
			Collection<ThresholdNotification> notifications) {
		notifySpeculativeThresholdsConsumer.accept(notifications);
		return CompletableFuture.completedFuture(Acknowledge.get());
	}
