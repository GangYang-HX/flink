...
public class CheckpointCoordinatorTestingUtils {
	...
	public static ExecutionVertex mockExecutionVertex(ExecutionAttemptID attemptID) {
		return mockExecutionVertex(attemptID, (LogicalSlot) null);
	}

	public static ExecutionVertex mockExecutionVertex(
	...
	public static class CheckpointCoordinatorBuilder {
		...
		private CheckpointHandler checkpointHandler = null;
		...
		public CheckpointCoordinatorBuilder setCheckpointHandler(CheckpointHandler handler) {
