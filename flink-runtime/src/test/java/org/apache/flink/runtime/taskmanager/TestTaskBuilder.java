...
public final class TestTaskBuilder {
	...
	private JobManagerTaskRestore taskRestoreState = new JobManagerTaskRestore(1L, new TaskStateSnapshot());
	...
	public TestTaskBuilder setTaskRestoreState(JobManagerTaskRestore taskRestoreState) {
		this.taskRestoreState = taskRestoreState;
		return this;
	}
