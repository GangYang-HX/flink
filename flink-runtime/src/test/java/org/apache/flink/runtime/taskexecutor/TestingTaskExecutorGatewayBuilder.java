...
public class TestingTaskExecutorGatewayBuilder {
	...
	private static final Consumer<Collection<ThresholdNotification>> NOOP_NOTIFY_SPECULATIVE_THRESHOLDS_CONSUMER = ignored -> {};
	...
	private Consumer<Collection<ThresholdNotification>> notifySpeculativeThresholdsConsumer = NOOP_NOTIFY_SPECULATIVE_THRESHOLDS_CONSUMER;
	...
	public TestingTaskExecutorGatewayBuilder setNotifySpeculativeThresholdsConsumer(
			Consumer<Collection<ThresholdNotification>> notifySpeculativeThresholdsConsumer) {
		this.notifySpeculativeThresholdsConsumer = notifySpeculativeThresholdsConsumer;
		return this;
	}
	...
	public TestingTaskExecutorGateway createTestingTaskExecutorGateway() {
		return new TestingTaskExecutorGateway(
			...
			notifySpeculativeThresholdsConsumer);
	}
}
