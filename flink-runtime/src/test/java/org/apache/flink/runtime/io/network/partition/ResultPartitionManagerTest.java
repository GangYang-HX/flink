...
public class ResultPartitionManagerTest extends TestLogger {
	...
	/**
	 * Tests that {@link ResultPartitionManager#createSubpartitionView(ResultPartitionID, int, BufferAvailabilityListener, boolean)}
	...
	/**
	 * Tests {@link ResultPartitionManager#createSubpartitionView(ResultPartitionID, int, BufferAvailabilityListener, boolean)}
