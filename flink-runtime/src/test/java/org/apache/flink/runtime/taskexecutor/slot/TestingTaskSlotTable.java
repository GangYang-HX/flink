...
public class TestingTaskSlotTable<T extends TaskSlotPayload> implements TaskSlotTable<T> {
	...
	private final Supplier<SlotOfferReport> createSlotOfferReportSupplier;
	private final Supplier<TaskExecutionStateReport> createTaskExecutionStateReportSupplier;
	...
	private TestingTaskSlotTable(
			...
			Supplier<SlotOfferReport> createSlotOfferReportSupplier,
			Supplier<TaskExecutionStateReport> createTaskExecutionStateReportSupplier,
		...
		this.createSlotOfferReportSupplier = createSlotOfferReportSupplier;
		this.createTaskExecutionStateReportSupplier = createTaskExecutionStateReportSupplier;
	...
	public SlotOfferReport createSlotOfferReport(JobID jobId) {
		return createSlotOfferReportSupplier.get();
	}

	@Override
	public TaskExecutionStateReport createTaskExecutionStateReport(JobID jobId) {
		return createTaskExecutionStateReportSupplier.get();
	}
	...
	public static class TestingTaskSlotTableBuilder<T extends TaskSlotPayload> {
		...
		private Supplier<SlotOfferReport> createSlotOfferReportSupplier = SlotOfferReport::new;
		private Supplier<TaskExecutionStateReport> createTaskExecutionStateReportSupplier = TaskExecutionStateReport::new;
		...
		public TestingTaskSlotTableBuilder<T> createSlotOfferReportSupplier(Supplier<SlotOfferReport> createSlotOfferReportSupplier) {
			this.createSlotOfferReportSupplier = createSlotOfferReportSupplier;
			return this;
		}

		public TestingTaskSlotTableBuilder<T> createTaskExecutionStateReportSupplier(Supplier<TaskExecutionStateReport> createTaskExecutionStateReportSupplier) {
			this.createTaskExecutionStateReportSupplier = createTaskExecutionStateReportSupplier;
			return this;
		}
		...
		public TaskSlotTable<T> build() {
			return new TestingTaskSlotTable<>(
				...
				createSlotOfferReportSupplier,
				createTaskExecutionStateReportSupplier,
