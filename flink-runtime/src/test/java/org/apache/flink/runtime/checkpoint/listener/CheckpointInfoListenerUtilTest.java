...
public class CheckpointInfoListenerUtilTest {
    ...
    public void testEnableRegistListener() {
        List<CheckpointInfoListener> registeredListeners = CheckpointInfoListenerUtil.getRegisteredListeners(true);
    ...
    public void testDisableRegistListener() {
        List<CheckpointInfoListener> registeredListeners = CheckpointInfoListenerUtil.getRegisteredListeners(false);
