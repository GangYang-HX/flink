...
public class LocalInputChannelTest {
	...
	public void testCheckpointingInflightData() throws Exception {
		...
		ResultSubpartitionView subpartitionView = subpartition.createReadView(false, () -> {});
	...
	public void testAnnounceNewBufferSize() throws IOException, InterruptedException {
		...
		LocalInputChannel channel0 =
				createLocalInputChannel(
						...
						new TestingResultPartitionManager(subpartition0.createReadView(false, () -> {})));
		LocalInputChannel channel1 =
				createLocalInputChannel(
						new SingleInputGateBuilder().build(),
						new TestingResultPartitionManager(subpartition1.createReadView(false, () -> {})));
	...
	private static ResultSubpartitionView createResultSubpartitionView(BufferConsumer... buffers) throws IOException {
		...
		return subpartition.createReadView(false, () -> {});
	}
