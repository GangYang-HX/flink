...
public class TestingJobMasterGatewayBuilder {
	...
	private BiConsumer<ResourceID, TaskExecutorHeartbeatPayloadForJobMaster> taskManagerHeartbeatConsumer = (ignoredA, ignoredB) -> {};
	...
	private Supplier<CompletableFuture<Long>> triggerFullCheckpointSupplier = () -> CompletableFuture.completedFuture(0L);
	...
	private Consumer<AcknowledgeTriggerSnapshot> acknowledgeTriggerSnapshotConsumer = ignored -> {};
	...
	public TestingJobMasterGatewayBuilder setTaskManagerHeartbeatConsumer(BiConsumer<ResourceID, TaskExecutorHeartbeatPayloadForJobMaster> taskManagerHeartbeatConsumer) {
	...
	public TestingJobMasterGatewayBuilder setAcknowledgeTriggerSnapshotConsumer(
			Consumer<AcknowledgeTriggerSnapshot> acknowledgeTriggerSnapshotConsumer) {
	...
	public TestingJobMasterGateway build() {
		return new TestingJobMasterGateway(
			...
			acknowledgeTriggerSnapshotConsumer,
