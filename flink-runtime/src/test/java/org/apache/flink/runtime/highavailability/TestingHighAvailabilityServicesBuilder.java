...
public class TestingHighAvailabilityServicesBuilder {
	...
	public TestingHighAvailabilityServices build() {
		...
		testingHighAvailabilityServices.setArchivedExecutionGraphStore(archivedExecutionGraphStore);
    ...
    public TestingHighAvailabilityServicesBuilder setArchivedExecutionGraphStore(ArchivedExecutionGraphStore archivedExecutionGraphStore) {
