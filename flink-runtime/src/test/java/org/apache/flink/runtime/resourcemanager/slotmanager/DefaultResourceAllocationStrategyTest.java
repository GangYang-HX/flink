...
public class DefaultResourceAllocationStrategyTest extends TestLogger {
    ...
    @Test
    public void testBlockedTaskManagerCannotFulfillRequirements() {
        ...
        Assertions.assertThat(result.getUnfulfillableJobs()).isEmpty();
        Assertions.assertThat(result.getAllocationsOnRegisteredResources()).isEmpty();
        Assertions.assertThat(result.getPendingTaskManagersToAllocate()).hasSize(2);
    }
}
