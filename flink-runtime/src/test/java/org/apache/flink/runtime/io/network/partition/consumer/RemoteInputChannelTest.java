...
public class RemoteInputChannelTest {
	...
	private static final CheckpointOptions UNALIGNED = CheckpointOptions.unaligned(CheckpointType.CHECKPOINT, getDefault());
	private static final CheckpointOptions ALIGNED_WITH_TIMEOUT = alignedWithTimeout(CheckpointType.CHECKPOINT, getDefault(), 10);
    ...
    public void testExceptionOnPersisting() throws Exception {
        ...
        inputChannel.checkpointStarted(
                new CheckpointBarrier(
                        42, System.currentTimeMillis(), CheckpointOptions.unaligned(CheckpointType.CHECKPOINT, getDefault())));
