...
public class ResourceManagerTest extends TestLogger {
    ...
    @Test
    public void testUnblockResourcesWillTriggerResourceRequirementsCheck() throws Exception {
    ...
    @Test
    public void testNewlyAddedBlockedNodesWillBeSynchronizedToAllRegisteredJobMasters()
            throws Exception {
        ...
        Assertions.assertTrue(receivedBlockedNodes1.contains(blockedNode1));
        Assertions.assertEquals(1, receivedBlockedNodes1.size());
        Assertions.assertTrue(receivedBlockedNodes2.contains(blockedNode1));
        Assertions.assertEquals(1, receivedBlockedNodes2.size());
        ...
        Assertions.assertTrue(receivedBlockedNodes1.contains(blockedNode1));
        Assertions.assertTrue(receivedBlockedNodes2.contains(blockedNode1));
        Assertions.assertTrue(receivedBlockedNodes2.contains(blockedNode2));
    }
