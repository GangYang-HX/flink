...
public class CheckpointTypeTest {
	...
	public void testOrdinalsAreConstant() {
		...
		assertEquals(2, CheckpointType.INCREMENTAL_FULL_CHECKPOINT.ordinal());
		assertEquals(3, CheckpointType.SAVEPOINT.ordinal());
		assertEquals(4, CheckpointType.SYNC_SAVEPOINT.ordinal());
	}
}
