...
public class CheckpointTestUtils {
	...
	public static Map<OperatorID, Tuple2<String, String>> createOperatorNameAndTypes(Random random, int operatorNum) {
		...
		for (int i = 0; i < operatorNum; i++) {
			...
			operatorNameAndTypes.put(new OperatorID(), new Tuple2<>(operatorName, typeName));
		}
