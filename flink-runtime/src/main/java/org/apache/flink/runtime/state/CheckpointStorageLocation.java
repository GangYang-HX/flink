...
public interface CheckpointStorageLocation extends CheckpointStreamFactory {
	...
	/**
	 * Gets metadata file full path in external persistence system (e.g. file system checkpoint storage or other
	 * persistence checkpoint storage), otherwise this method will return null.
	 */
