...
public class ExecutionGraphBuilder {
	...
	public static ExecutionGraph buildGraph(
			...
			Time reconcileTimeout) throws JobExecutionException, JobException {
	...
	public static ExecutionGraph buildGraph(
		...
		if (snapshotSettings != null) {
			...
			executionGraph.enableCheckpointing(
				...
				confirmVertices,
				hooks,
				snapshotSettings.getOperatorNameAndTypes(),
				checkpointIdCounter,
				completedCheckpoints,
				rootBackend,
				checkpointStatsTracker);
		} else {
			executionGraph.setOperatorNameAndTypes(Collections.emptyMap());
		}
