...
public interface Environment {
	...
	/**
	 * Create (if necessary), and return the reference to the globally unique instance (on JobManager or
	 * on TaskManager) of SpeculativeManager
	 */
	default SpeculativeTasksManager getSpeculativeManager() {
		throw new UnsupportedOperationException("Speculative Manager not be supported in this environment!");
	}

	default void acknowledgeTriggerSnapshot(long checkpointId, long delay) {
	}
}
