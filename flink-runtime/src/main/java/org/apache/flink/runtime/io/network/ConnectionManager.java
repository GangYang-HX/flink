...
public interface ConnectionManager {
	...
	default void destroyPartitionRequestClient(ConnectionID connectionId){
		throw new UnsupportedOperationException(
			"The method destroyPartitionRequestClient is not supported by " + this.getClass().getSimpleName());
	};
}
