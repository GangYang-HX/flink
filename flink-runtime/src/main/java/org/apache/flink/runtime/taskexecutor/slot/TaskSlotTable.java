...
public interface TaskSlotTable<T extends TaskSlotPayload> extends TimeoutListener<AllocationID>, AutoCloseableAsync {
	...
	/**
	 * Create {@link TaskExecutionStateReport} which will be carried in payload of the heartbeat from TM to JM.
	 *
	 * @param jobId The {@code JobID} of the job.
	 * @return The {@code SlotOfferReport} of the job.
	 */
	SlotOfferReport createSlotOfferReport(JobID jobId);

	/**
	 * Create {@link TaskExecutionStateReport} which will be carried in payload of the heartbeat from TM to JM.
	 *
	 * @param jobId The {@code JobID} of the job.
	 * @return The {@code TaskExecutionStateReport} of the job.
	 */
	TaskExecutionStateReport createTaskExecutionStateReport(JobID jobId);
