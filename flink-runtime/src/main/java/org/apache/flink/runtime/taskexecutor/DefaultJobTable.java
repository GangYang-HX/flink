...
public final class DefaultJobTable implements JobTable {
	...
	private final class JobOrConnection implements JobTable.Job, JobTable.Connection {
		...
		@Override
		public SpeculativeTasksManager getSpeculativeTasksManager() {
			return verifyContainsEstablishedConnection().getSpeculativeTasksManager();
		}
	...
	private static final class EstablishedConnection {
		...
		// SpeculativeTasksManager interface to job manager
		...
		private EstablishedConnection(
			...
			this.speculativeTasksManager = Preconditions.checkNotNull(speculativeTasksManager);
		}
