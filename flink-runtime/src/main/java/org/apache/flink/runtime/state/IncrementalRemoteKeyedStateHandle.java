...
public class IncrementalRemoteKeyedStateHandle implements IncrementalKeyedStateHandle {
	...
	public Set<SharedStateRegistryKey> getSharedStateRegistryKeys() {
		return getSharedStateHandleIDs().
			stream().
			map(stateHandleID -> createSharedStateRegistryKeyFromFileName(stateHandleID)).
	...
	public void discardState() throws Exception {
		...
		try {
			metaStateHandle.discardStateWithRetry();
		} catch (Exception e) {
	...
	public void registerSharedStates(SharedStateRegistry stateRegistry) {
		registerSharedStates(-1, stateRegistry);
	}

	@Override
	public void registerSharedStates(long checkpointId, SharedStateRegistry stateRegistry) {
