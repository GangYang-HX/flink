...
public interface HighAvailabilityServices extends ClientHighAvailabilityServices {
	...
	/**
	 * Gets the archived execution graph store for the job manager, ArchivedExecutionGraph is used
	 * to restore ExecutionGraph in HA.
	 *
	 * @return archived execution graph store
	 * @throws Exception if archived execution graph store could not be created
	 */
    ArchivedExecutionGraphStore getArchivedExecutionGraphStore() throws Exception;
