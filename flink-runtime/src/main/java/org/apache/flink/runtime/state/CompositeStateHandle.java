...
public interface CompositeStateHandle extends StateObject {
	 ...
	 * from the registry.
	 *
	 * @param checkpointId the ID of the checkpoint that the CompositeStateHandle registered for.
	 * @param sharedStateRegistry The registry where shared states are registered.
	 */
	default void registerSharedStates(long checkpointId, SharedStateRegistry sharedStateRegistry) {
