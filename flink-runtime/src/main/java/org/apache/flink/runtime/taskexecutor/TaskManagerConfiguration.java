...
public class TaskManagerConfiguration implements TaskManagerRuntimeInfo {
	...
	public long getYarnExpiryIntervalMs() {
		return yarnExpiryIntervalMs;
	}
	...
	public static TaskManagerConfiguration fromConfiguration(
		...
		long yarnExpiryIntervalMs = configuration.getLong(HighAvailabilityOptions.HA_YARN_LIVENESS_MONITOR_EXPIRY_INTERVAL_MS);
