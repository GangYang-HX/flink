...
public class CheckpointException extends Exception {
	...
	public CheckpointException(CheckpointFailureReason failureReason, String additionalInfo) {
		super(new Throwable(String.format("%s [Detail]: %s", failureReason.message(), additionalInfo)));
		this.checkpointFailureReason = Preconditions.checkNotNull(failureReason);
	}
