...
public abstract class InputChannel {
	...
	public void reRequestSubpartition(int subpartitionIndex) throws IOException, InterruptedException {
		throw new UnsupportedOperationException(
			"The method reRequestSubpartition is not supported by " + this.getClass().getSimpleName());
	}
	...
	public void markReconnection() {
		throw new UnsupportedOperationException(
			"The method markReconnection is not supported for " + this.getClass().getSimpleName());
	}
	...
	/**
	 * Mark this input channel as unavailable.
	 */
	public void markUnavailable() {
		throw new UnsupportedOperationException(
			"The method markUnavailable is not supported for " + this.getClass().getSimpleName());
	}
