...
public class TaskManagerServicesConfiguration {
	...
	private Optional<String> cgroupMetricsFilePath;

	private Long cgroupMetricsProbingInterval;
	...
	private TaskManagerServicesConfiguration(
			...
			int numIoThreads,
			Optional<String> cgroupMetricsFilePath,
		...
		this.cgroupMetricsFilePath = cgroupMetricsFilePath;
		this.cgroupMetricsProbingInterval = cgroupMetricsProbingInterval;
	}
	...
	public Optional<String> getCgroupMetricsFilePath() {
		return cgroupMetricsFilePath;
	}

	public Long getCgroupMetricsProbingInterval() {
		return cgroupMetricsProbingInterval;
	}
	...
	public static TaskManagerServicesConfiguration fromConfiguration(
		...
		return new TaskManagerServicesConfiguration(
			...
			numIoThreads,
			ConfigurationUtils.getCGroupMetricsPath(configuration),
			ConfigurationUtils.getCGroupMetricsProbingIntervel(configuration));
	}
}
