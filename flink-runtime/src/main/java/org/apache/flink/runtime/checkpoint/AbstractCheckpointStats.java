...
public abstract class AbstractCheckpointStats implements Serializable {
	...
	// TODO In 'Checkpoints' tab on Flink Web UI, change the 'Acknowledged' column to 'Acknowledged/Mapped'.
	//      And it shows '(`numberOfAcknowledged`+`numberOfLogicallyMappedSubtasks`)/`numberOfSubtasks`'
