...
public class NettyProtocol {
	...
	public ChannelHandler[] getServerChannelHandlers() {
		PartitionRequestQueue queueOfPartitionQueues = runtimeNetworkRetryEnabled ?
			new NetworkRetryPartitionRequestQueue() :
	...
	public ChannelHandler[] getClientChannelHandlers() {
		NetworkClientHandler networkClientHandler = runtimeNetworkRetryEnabled ?
			new NetworkRetryCreditBasePartitionRequestClientHandler() :
