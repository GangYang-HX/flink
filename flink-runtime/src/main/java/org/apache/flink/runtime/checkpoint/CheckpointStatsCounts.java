...
public class CheckpointStatsCounts implements Serializable {
	...
	/** Number of consecutive failed checkpoints. */
	private int numConsecutiveFailedCheckpoints;
	...
	private CheckpointStatsCounts(
			...
			int numConsecutiveFailedCheckpoints) {
		...
		checkArgument(numConsecutiveFailedCheckpoints >= 0, "Negative number of consecutive failed checkpoints");
		...
		this.numConsecutiveFailedCheckpoints = numConsecutiveFailedCheckpoints;
	}
	...
	/**
	 * Returns the number of consecutive failed checkpoints.
	 *
	 * @return Number of consecutive failed checkpoints.
	 */
	public int getNumberOfConsecutiveFailedCheckpoints() {
		return numConsecutiveFailedCheckpoints;
	}
	...
	/**
	 * Increments the number of consecutive failed checkpoints.
	 */
	void incrementConsecutiveFailedCheckpoints() {
		numConsecutiveFailedCheckpoints++;
	}

	/**
	 * Reset the number of consecutive failed checkpoints.
	 */
	void resetConsecutiveFailedCheckpoints() {
		numConsecutiveFailedCheckpoints = 0;
	}
