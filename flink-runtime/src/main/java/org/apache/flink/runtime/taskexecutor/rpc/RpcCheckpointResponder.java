...
public class RpcCheckpointResponder implements CheckpointResponder {
	...
	@Override
	public void acknowledgeTriggerSnapshot(
			JobID jobId,
			ExecutionAttemptID executionAttemptID,
			long checkpointId,
			long delay) {
		checkpointCoordinatorGateway.acknowledgeTriggerSnapshot(
				new AcknowledgeTriggerSnapshot(jobId, executionAttemptID, checkpointId, delay));
	}
}
