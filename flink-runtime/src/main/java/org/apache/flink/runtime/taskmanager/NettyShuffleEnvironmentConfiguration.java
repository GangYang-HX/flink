...
public class NettyShuffleEnvironmentConfiguration {
	...
	private final boolean runtimeNetworkRetryEnabled;
	...
	public NettyShuffleEnvironmentConfiguration(
			...
			boolean runtimeNetworkRetryEnabled,
		...
		this.runtimeNetworkRetryEnabled = runtimeNetworkRetryEnabled;
	...
	public boolean isRuntimeNetworkRetryEnabled() {
		return this.runtimeNetworkRetryEnabled;
	}
	...
	public static NettyShuffleEnvironmentConfiguration fromConfiguration(
		...
		int maxNumConnections =
			Math.max(1, configuration.getInteger(NettyShuffleEnvironmentOptions.MAX_NUM_TCP_CONNECTIONS));

		boolean runtimeNetworkRetryEnabled =
			configuration.get(NettyShuffleEnvironmentOptions.RUNTIME_NETWORK_RETRY_ENABLED);
