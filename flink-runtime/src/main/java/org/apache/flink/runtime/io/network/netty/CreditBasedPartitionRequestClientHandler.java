...
class CreditBasedPartitionRequestClientHandler extends ChannelInboundHandlerAdapter implements NetworkClientHandler {
	...
	protected final ConcurrentMap<InputChannelID, RemoteInputChannel> inputChannels = new ConcurrentHashMap<>();
	...
	public void channelInactive(ChannelHandlerContext ctx) throws Exception {
		...
		if (!inputChannels.isEmpty()) {
			...
			String errorMessage = "Connection unexpectedly closed by remote task manager '" + remoteAddr + "'. "
					+ "This might indicate that the remote task manager was lost.";
			notifyAllChannelsOfErrorAndClose(new RemoteTransportException(errorMessage, remoteAddr));
		}
	...
	protected void notifyAllChannelsOfErrorAndClose(Throwable cause) {
