...
public interface PartitionRequestClient {
	...
	/**
	 * Requests the remote subpartition again after the original connection broken.
	 *
	 * @param partitionId The identifier of result partition to be requested.
	 * @param subpartitionIndex The subpartition index in the requested result partition.
	 * @param inputChannel The remote input channel for requesting the subpartition.
	 */
	default void reRequestSubpartition(
			ResultPartitionID partitionId,
			int subpartitionIndex,
