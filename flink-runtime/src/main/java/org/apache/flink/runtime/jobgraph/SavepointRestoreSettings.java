...
public class SavepointRestoreSettings implements Serializable {
	...
	private static final SavepointRestoreSettings NONE = new SavepointRestoreSettings(null, false, RestoreMode.DEFAULT);
	 ...
	 */
	private SavepointRestoreSettings(String restorePath, boolean allowNonRestoredState, RestoreMode restoreMode) {
