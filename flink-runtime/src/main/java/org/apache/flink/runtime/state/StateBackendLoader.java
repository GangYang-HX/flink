...
public class StateBackendLoader {
	...
	/** The shortcut configuration name for the Taishan State Backend */
	public static final String TAISHAN_STATE_BACKEND_NAME = "taishan";
	...
	public static StateBackend loadStateBackendFromConfig(
		...
		switch (backendName.toLowerCase()) {
			...
			case TAISHAN_STATE_BACKEND_NAME:
				factoryClassName = "org.apache.flink.taishan.state.TaishanStateBackendFactory";
				break;
