...
public abstract class AbstractMetricGroup<A extends AbstractMetricGroup<?>> implements MetricGroup {
	...
	public MetricGroup addGroup(String name) {
		return addGroup(name, ChildType.GENERIC, QueryServiceMode.INHERIT);
	}
	...
	private AbstractMetricGroup<?> addGroup(String name, ChildType childType, QueryServiceMode mode) {
		synchronized (this) {
			if (!closed) {
				...
				QueryServiceMode childMode = QueryServiceMode.INHERIT == mode ? this.getQueryServiceMode() : mode;
