...
public class BlobUtils {
	 ...
	 *
	 * <p> This variable is from org.apache.hadoop.yarn.api.ApplicationConstants.LOCAL_DIRS,
	 * we define here again to avoid importing yarn's dependency.
	 */
	...
	static File initLocalStorageDirectory(Configuration config) throws IOException {
		...
		boolean yarnMode = !StringUtils.isNullOrWhitespaceOnly(appId)
