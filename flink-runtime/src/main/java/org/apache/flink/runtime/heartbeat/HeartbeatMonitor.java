...
public interface HeartbeatMonitor<O> {
	...
	interface Factory<O> {
		 ...
		 * @param haReconcileEnabled		 the ha reconcile
		 * @param yarnExpiryIntervalMs       Wait for another yarnExpiryIntervalMs milliseconds for
		 *                                   the new JobManager to be restarted if haReconcileEnabled is `true`
