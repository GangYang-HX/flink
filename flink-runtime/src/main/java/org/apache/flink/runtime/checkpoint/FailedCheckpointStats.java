...
public class FailedCheckpointStats extends AbstractCheckpointStats {
	...
	/** Number of tasks whose states are mapped from a previously completed checkpoint. */
	 ...
	 * @param numLogicallyMappedSubtasks Number of subtasks whose states are logically
	 *                                   mapped from a previously completed checkpoint.
