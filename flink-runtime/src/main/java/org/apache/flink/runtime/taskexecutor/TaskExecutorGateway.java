...
public interface TaskExecutorGateway extends RpcGateway, TaskExecutorOperatorEventGateway {
	...
	/**
	 * Notifies the task executor to update the thresholds.
	 * @param jobID jobID
	 * @param notifications notifications
	 * @return nothing
	 */
	CompletableFuture<Acknowledge> notifySpeculativeThresholds(JobID jobID, Collection<ThresholdNotification> notifications);
}
