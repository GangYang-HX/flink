...
public abstract class ResultPartition implements ResultPartitionWriter {
	...
	public BufferBuilder getBufferBuilder(int targetChannel) throws IOException, InterruptedException {
		...
		if (subpartitions[targetChannel].isAvailable()) {
	...
	public int addBufferConsumer(
		...
		return subpartition.add(bufferConsumer, partialRecordLength);
	}
	...
	public ResultSubpartitionView createSubpartitionView(
		...
		ResultSubpartitionView readView = subpartitions[index].createReadView(isRetry, availabilityListener);
	...
	public void notifyReadViewCreated(int subPartitionIndex) {
		subpartitions[subPartitionIndex].forceResumeConsumption();
	}
}
