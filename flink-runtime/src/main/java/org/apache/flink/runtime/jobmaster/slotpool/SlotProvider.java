...
public interface SlotProvider {
	...
	/**
	 * Restore Execution's {@link org.apache.flink.runtime.jobmaster.LogicalSlot} with initial offers sent from TM.
	 *
	 * @param taskManagerLocation from which the slot offers originate
	 * @param taskManagerGateway to talk to the slot offerer
	 * @param initialOffers initial slot offers which are used to restore the {@link SlotPool}
	 * @return Collection of {@link AllocatedSlot}
	 */
	default Collection<AllocatedSlot> restoreSlots(
