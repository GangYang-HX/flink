...
public class ZooKeeperUtils {
    ...
    /**
     * Creates a {@link org.apache.flink.runtime.jobmanager.FileSystemArchivedExecutionGraphStore}
     * instance.
     *
     * @param configuration {@link Configuration} object
     * @return {@link org.apache.flink.runtime.jobmanager.FileSystemArchivedExecutionGraphStore}
     *     instance
     * @throws Exception if the archived execution graph store cannot be created
     */
    public static ArchivedExecutionGraphStore createArchivedExecutionGraphStore(
            Configuration configuration) throws Exception {
        FileSystem fs =
