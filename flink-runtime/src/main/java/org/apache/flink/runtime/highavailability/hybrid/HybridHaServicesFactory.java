...
public class HybridHaServicesFactory implements HighAvailabilityServicesFactory {
	...
	public HighAvailabilityServices createHAServices(Configuration configuration, Executor executor) throws Exception {
		...
		Executor haExecutor = Executors.newCachedThreadPool(new ExecutorThreadFactory("hybrid-ha-io"));

		return new HybridHaServices(client, fs, haExecutor, configuration, blobStoreService);
	}
	...
	public ClientHighAvailabilityServices createClientHAServices(Configuration configuration) throws Exception {
		...
		return new HybridClientHAServices(client, fs, configuration);
	}
}
