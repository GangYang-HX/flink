...
public interface StateObject extends Serializable {
	 ...
	 * If it doesn't return after a certain time, the method will retry.
	 * @see org.apache.flink.runtime.fs.hdfs.HadoopFileSystem
	 */
	default void discardStateWithRetry() throws Exception {
		discardState();
	}
