...
/**
 * This is an empty implementation of {@link CheckpointInfoListener}. This is supplied because the users may only
 * care about one or two of the notifications. We supply this empty implementation so that they don't have to
 * implement the unnecessary methods.
 */
