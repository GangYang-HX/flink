...
public abstract class AbstractFetcher<T, KPH> {
    ...
    public List<KafkaTopicPartitionState<T, KPH>> getSubscribedPartitionStates(){
	...
	protected AbstractFetcher(
		...
		this.legacyCurrentOffsetsMetricGroup = consumerMetricGroup.addGroup(LEGACY_CURRENT_OFFSETS_METRICS_GROUP, QueryServiceMode.DISABLED);
		this.legacyCommittedOffsetsMetricGroup = consumerMetricGroup.addGroup(LEGACY_COMMITTED_OFFSETS_METRICS_GROUP, QueryServiceMode.DISABLED);
