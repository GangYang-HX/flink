...
// */
//@Internal
//public class RowDataPartitionComputer implements PartitionComputer<Row> {
//
...
//			Object field = Row.get(in, partitionIndexes[i], partitionTypes[i]);
