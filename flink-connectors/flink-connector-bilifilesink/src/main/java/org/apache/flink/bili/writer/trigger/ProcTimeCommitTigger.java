...
import static org.apache.flink.bili.writer.FileSystemOptions.SINK_PARTITION_COMMIT_DELAY;
...
public class ProcTimeCommitTigger extends PartitionCommitTrigger {
    ...
    public ProcTimeCommitTigger(
        ...
        Path locationPath, TableMetaStoreFactory metaStoreFactory) throws Exception {
