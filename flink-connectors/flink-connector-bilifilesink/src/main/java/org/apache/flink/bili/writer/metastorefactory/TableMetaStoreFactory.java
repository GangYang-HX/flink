...
public interface TableMetaStoreFactory extends Serializable {
	...
	interface TableMetaStore extends Closeable {
		...
		void createOrAlterPartition(LinkedHashMap<String, String> partitionSpec, Path partitionPath, boolean eagerCommit) throws Exception;

		/**
		 *
		 * @param partitionSpec
		 * @param partitionPath
		 * @param tableMetaStore
		 * @param triggerMetricsWrapper
		 * @param trace
		 * @throws Exception
		 */
		void createIfNotExistPartition(LinkedHashMap<String, String> partitionSpec, Path partitionPath, TableMetaStore tableMetaStore, TriggerMetricsWrapper triggerMetricsWrapper, Trace trace) throws Exception;

		/**
		 * add a parameter : eagerCommit
		 * @param partitionSpec
		 * @param partitionPath
		 * @param tableMetaStore
		 * @param triggerMetricsWrapper
		 ...
		 * @throws Exception
		 */
		void createIfNotExistPartition(LinkedHashMap<String, String> partitionSpec, Path partitionPath, TableMetaStore tableMetaStore, TriggerMetricsWrapper triggerMetricsWrapper, Trace trace,boolean eagerCommit) throws Exception;

	}

	/**
	 * Create Meta Store if is null
	 * @return create if is null
	 * @throws Exception exp
	 */
	TableMetaStore getTableMetaStore(TableMetaStoreFactory.TableMetaStore tableMetaStore) throws Exception;
}
