...
public class HiveOptions {
    ...
    public static final ConfigOption<Boolean> BATCH_LOOKUP_SOURCE_FETCH_LATEST_PARTITION =
            key("batch-lookup-source.fetch-latest-partition").booleanType().defaultValue(true);
