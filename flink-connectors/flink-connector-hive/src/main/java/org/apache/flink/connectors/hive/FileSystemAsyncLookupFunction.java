 ...
 */
public class FileSystemAsyncLookupFunction<P> extends TableFunction<RowData> {

    private static final Logger LOG = LoggerFactory.getLogger(FileSystemAsyncLookupFunction.class);
    ...
    public transient static Cache<RowData, List<RowData>> cache;

    public FileSystemAsyncLookupFunction(
    ...
    public void open(FunctionContext context) throws Exception {
        ...
        //add metric
        this.threadRtQuery = context.getMetricGroup()
    ...
    /**
     * Do not clear the cache before updating, keep the same logic as Flink-1.11, and continuously update the key
     */
