...
public class SqlTree {
    ...
    public SqlTree(String multiSql) {
        ...
        if (multiSql.contains("HIVE_CATALOG.")){
            createCatalogSqlList.add("CREATE CATALOG HIVE_CATALOG WITH ('type' = 'hive')");
        }
        if (multiSql.contains("HIVE_CATALOG_TEST.")){
            createCatalogSqlList.add("CREATE CATALOG HIVE_CATALOG_TEST WITH (\n"
                    + "   'type' = 'hive',\n"
    ...
    private List<String> splitSql(String multiSql) {
        ...
        String newSql = replaceIgnoreQuote(multiSql, "\r\n", " \n");
        newSql = replaceFlagNotInQuoteExcludeNewline(newSql, "/*", "*/", " ");
        newSql = replaceFlagNotInQuoteExcludeNewline(newSql, "--", "\n", " ");
        newSql = replaceIgnoreQuote(newSql, "\n", " ");
    ...
    private String replaceFlagNotInQuoteExcludeNewline(
            String sql,
            String startFlag,
            String endFlag,
            String replace) {
