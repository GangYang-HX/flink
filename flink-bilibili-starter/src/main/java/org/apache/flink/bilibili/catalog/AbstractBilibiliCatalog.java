 ...
 */
public abstract class AbstractBilibiliCatalog extends AbstractCatalog {

	private static final Logger LOG = LoggerFactory.getLogger(AbstractBilibiliCatalog.class);

	public AbstractBilibiliCatalog(String name, String defaultDataSource, String defaultDatabase) {
