...
//		streamGraph.setScheduleMode(ScheduleMode.LAZY_FROM_SOURCES_WITH_BATCH_SLOT_REQUEST);
        ...
        streamGraph.setGlobalStreamExchangeMode(getGlobalDataExchangeMode(tableConfig));
	}

	private static boolean isShuffleModeAllBlocking(TableConfig tableConfig) {
		return getGlobalDataExchangeMode(tableConfig) == GlobalStreamExchangeMode.ALL_EDGES_BLOCKING;
	}

	private static GlobalStreamExchangeMode getGlobalDataExchangeMode(TableConfig tableConfig) {
