 ...
 */
@PublicEvolving
public interface CatalogMaterializedView extends CatalogBaseTable {
     ...
     */
    static CatalogMaterializedView of(
            Schema schema,
            @Nullable String comment,
            String originalQuery,
            String expandedQuery,
            Map<String, String> options) {
        return new DefaultCatalogMaterializedView(
                schema, comment, originalQuery, expandedQuery, options);
    }

    static CatalogTable asCatalogTable(CatalogMaterializedView mv) {
        return CatalogTable.of(
                mv.getUnresolvedSchema(),
                mv.getComment(),
