...
public class SqlClientOptions {
    ...
    public static final ConfigOption<String> PARSE_LISTENERS =
            ConfigOptions.key("sql-client.parse.listeners")
                    .stringType()
                    .noDefaultValue()
                    .withDescription(
                            "Listeners that will be executed by sequence to parse sql before execution");
}
