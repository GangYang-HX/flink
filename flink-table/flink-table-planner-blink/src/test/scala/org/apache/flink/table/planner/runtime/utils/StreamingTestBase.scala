...
import org.apache.flink.table.api.{EnvironmentSettings, ImplicitExpressionConversions, Table, TableConfig}
import org.apache.flink.table.planner.factories.TestValuesTableFactory
import org.apache.flink.table.runtime.operators.join.latency.config.GlobalConfiguration.LATENCY_REDIS_CONFIG
...
class StreamingTestBase extends AbstractTestBase {
  ...
  def before(): Unit = {
    ...
    flinkConfig.set(LATENCY_REDIS_CONFIG, "127.0.0.1")
    val customTableConfig = new TableConfig
    ...
    this.tEnv = StreamTableEnvironment.create(env, customTableConfig)
  }
