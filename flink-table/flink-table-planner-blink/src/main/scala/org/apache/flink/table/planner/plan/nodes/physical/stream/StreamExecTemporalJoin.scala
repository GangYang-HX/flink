...
import org.apache.flink.table.planner.plan.utils.{ExpandUtil, InputRefVisitor, KeySelectorUtil, RelExplainUtil, TemporalJoinUtil}
...
class StreamExecTemporalJoin(
  ...
  override protected def translateToPlanInternal(
    ...
    val ret = new TwoInputTransformation[RowData, RowData, RowData](leftTransform, rightTransform, getRelDetailedDescription, getFlinkRelTypeName, joinOperator, RowDataTypeInfo.of(returnType), leftTransform.getParallelism)
