...
class StreamExecSortLimit(
  ...
  override protected def translateToPlanInternal(
    ...
    val ret = new OneInputTransformation(inputTransform, getRelDetailedDescription, getFlinkRelTypeName, operator, outputRowTypeInfo, inputTransform.getParallelism)
