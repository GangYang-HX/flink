...
class StreamExecMiniBatchAssigner(
  ...
  override protected def translateToPlanInternal(
    ...
    val transformation = new OneInputTransformation[RowData, RowData](inputTransformation, getRelDetailedDescription, getFlinkRelTypeName, operator, outputRowTypeInfo, inputTransformation.getParallelism)
    transformation
  }
