...
class StreamExecJoin(
  ...
  override protected def translateToPlanInternal(
    ...
    val ret = new TwoInputTransformation[RowData, RowData, RowData](leftTransform, rightTransform, getRelDetailedDescription, getFlinkRelTypeName, operator, returnType, leftTransform.getParallelism)
