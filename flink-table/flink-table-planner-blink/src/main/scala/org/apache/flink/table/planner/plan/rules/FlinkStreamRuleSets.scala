...
import org.apache.flink.table.planner.plan.rules.physical.stream.{ExpandWindowTableFunctionTransposeRule, PullUpWindowTableFunctionIntoWindowAggregateRule, StreamPhysicalCalcRemoveRule, StreamPhysicalWindowAggregateRule, _}
...
object FlinkStreamRuleSets {
  ...
  val LOGICAL_PUSH_DOWN_EXTENSION: RuleSet = RuleSets.ofList(
    // scan optimization
  ...
  val PHYSICAL_OPT_RULES: RuleSet = RuleSets.ofList(
    ...
    StreamExecLatencyJoinRule.INSTANCE,
    StreamExecLatencyJoinV2Rule.INSTANCE,
    // CEP
  ...
  val PHYSICAL_LOOKUP_JOIN_RULES: RuleSet = RuleSets.ofList(
    StreamExecLookupJoinRule.SNAPSHOT_ON_TABLESCAN,
    StreamExecLookupJoinRule.SNAPSHOT_ON_CALC_TABLESCAN
  )

  val PHYSICAL_LOOKUP_JOIN_KEYED_RULES: RuleSet = RuleSets.ofList(
    StreamExecKeyedLookupJoinRule.SNAPSHOT_ON_KEYED_TABLESCAN,
    StreamExecKeyedLookupJoinRule.SNAPSHOT_ON_KEYED_CALC_TABLESCAN
  )
  /**
