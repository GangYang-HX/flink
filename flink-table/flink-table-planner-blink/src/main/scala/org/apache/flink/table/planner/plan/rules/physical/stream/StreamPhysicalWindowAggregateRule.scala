...
import org.apache.flink.table.planner.plan.nodes.physical.stream.{StreamExecCalc, StreamPhysicalWindowAggregate}
...
class StreamPhysicalWindowAggregateRule
  ...
  private def buildCalcProjection(
                                   ...
                                   timeColumns: Array[Int],
                                   agg: FlinkLogicalAggregate,
                                   windowAgg: StreamPhysicalWindowAggregate): StreamExecCalc = {
