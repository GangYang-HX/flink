...
class FlinkLogicalJoin(
  ...
  override def copy(
    ...
    new FlinkLogicalJoin(cluster, traitSet, hints.asInstanceOf[ImmutableList[RelHint]], left, right, conditionExpr, joinType)
  }
...
private class FlinkLogicalJoinConverter
  ...
  override def convert(rel: RelNode): RelNode = {
    ...
    FlinkLogicalJoin.create(hints, newLeft, newRight, join.getCondition, join.getJoinType)
  }
}
