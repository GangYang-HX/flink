...
import org.apache.flink.table.planner.plan.nodes.physical.stream.{StreamExecCalc, StreamExecExchange, StreamPhysicalWindowAggregate, StreamPhysicalWindowTableFunction}
...
class PullUpWindowTableFunctionIntoWindowAggregateRule
  ...
  override def matches(call: RelOptRuleCall): Boolean = {
    ...
    val calc: StreamExecCalc = call.rel(2)
