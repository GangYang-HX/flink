...
class StreamExecWatermarkAssigner(
  ...
  override protected def translateToPlanInternal(
    ...
    planner.getExecEnv.getConfig.setUseWatermark(true)
    ...
    val transformation = new OneInputTransformation[RowData, RowData](inputTransformation, getRelDetailedDescription, getFlinkRelTypeName, operatorFactory, outputRowTypeInfo, inputTransformation.getParallelism)
