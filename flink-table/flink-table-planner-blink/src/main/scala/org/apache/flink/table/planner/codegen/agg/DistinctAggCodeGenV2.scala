...
import org.apache.flink.table.planner.plan.utils.DistinctInfoV2
 ...
 */
class DistinctAggCodeGenV2(
  ctx: CodeGeneratorContext,
  distinctInfo: DistinctInfoV2,
  distinctIndex: Int,
  ...
  val valueGenerator: DistinctValueGeneratorV2 = createDistinctValueGeneratorV2()
  ...
  /**
   * The [[DistinctValueGeneratorV2]] is an abstraction for generating codes about the
   * distinct value.
   *
   ...
   */
  trait DistinctValueGeneratorV2 {
  ...
  /** Create a [[DistinctValueGeneratorV2]] instance for current [[DistinctAggCodeGenV2]] */
  private def createDistinctValueGeneratorV2(): DistinctValueGeneratorV2 = {
    if (!consumeRetraction) {
      if (aggCount <= JLong.SIZE) {
        new LongValueWithoutRetractionGeneratorV2
      } else {
        new LongArrayValueWithoutRetractionGeneratorV2
      }
    } else {
      if (aggCount <= 1) {
        new LongValueWithRetractionGeneratorV2
      } else {
        new LongArrayValueWithRetractionGeneratorV2
      }
    }
  }

  /** The generator used in non-retraction stream and number of aggregate <= 64 */
  class LongValueWithoutRetractionGeneratorV2 extends DistinctValueGeneratorV2 {
  ...
  /** The generator used in non-retraction stream and number of aggregate > 64 */
  class LongArrayValueWithoutRetractionGeneratorV2 extends DistinctValueGeneratorV2 {
    checkArgument(aggCount > JLong.SIZE)
  ...
  class LongValueWithRetractionGeneratorV2 extends DistinctValueGeneratorV2 {
  ...
  class LongArrayValueWithRetractionGeneratorV2 extends DistinctValueGeneratorV2 {
    checkArgument(aggCount > 1)
