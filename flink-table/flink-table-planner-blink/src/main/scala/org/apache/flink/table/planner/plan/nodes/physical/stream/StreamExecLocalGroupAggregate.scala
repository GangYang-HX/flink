...
class StreamExecLocalGroupAggregate(
  ...
  override protected def translateToPlanInternal(
    ...
    val transformation = new OneInputTransformation(inputTransformation, getRelDetailedDescription, getFlinkRelTypeName, operator, RowDataTypeInfo.of(outRowType), inputTransformation.getParallelism)
