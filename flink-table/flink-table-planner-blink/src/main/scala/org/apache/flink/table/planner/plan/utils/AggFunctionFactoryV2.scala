...
import org.apache.flink.table.planner.functions.aggfunctions.FirstValueAggFunction.{BooleanFirstValueAggFunction, ByteFirstValueAggFunction, DecimalFirstValueAggFunction, DoubleFirstValueAggFunction, FloatFirstValueAggFunction, IntFirstValueAggFunction, LongFirstValueAggFunction, ShortFirstValueAggFunction, StringFirstValueAggFunction}
import org.apache.flink.table.planner.functions.aggfunctions.FirstValueWithRetractAggFunction.{BooleanFirstValueWithRetractAggFunction, ByteFirstValueWithRetractAggFunction, DecimalFirstValueWithRetractAggFunction, DoubleFirstValueWithRetractAggFunction, FloatFirstValueWithRetractAggFunction, IntFirstValueWithRetractAggFunction, LongFirstValueWithRetractAggFunction, ShortFirstValueWithRetractAggFunction, StringFirstValueWithRetractAggFunction}
import org.apache.flink.table.planner.functions.aggfunctions.LastValueAggFunction.{BooleanLastValueAggFunction, ByteLastValueAggFunction, DecimalLastValueAggFunction, DoubleLastValueAggFunction, FloatLastValueAggFunction, IntLastValueAggFunction, LongLastValueAggFunction, ShortLastValueAggFunction, StringLastValueAggFunction}
import org.apache.flink.table.planner.functions.aggfunctions.LastValueWithRetractAggFunction.{BooleanLastValueWithRetractAggFunction, ByteLastValueWithRetractAggFunction, DecimalLastValueWithRetractAggFunction, DoubleLastValueWithRetractAggFunction, FloatLastValueWithRetractAggFunction, IntLastValueWithRetractAggFunction, LongLastValueWithRetractAggFunction, ShortLastValueWithRetractAggFunction, StringLastValueWithRetractAggFunction}
import org.apache.flink.table.planner.functions.aggfunctions.MaxWithRetractAggFunction.{BooleanMaxWithRetractAggFunction, ByteMaxWithRetractAggFunction, DateMaxWithRetractAggFunction, DecimalMaxWithRetractAggFunction, DoubleMaxWithRetractAggFunction, FloatMaxWithRetractAggFunction, IntMaxWithRetractAggFunction, LongMaxWithRetractAggFunction, ShortMaxWithRetractAggFunction, StringMaxWithRetractAggFunction, TimeMaxWithRetractAggFunction, TimestampMaxWithRetractAggFunction}
