...
abstract class StreamExecGroupWindowAggregateBase(
  ...
  override protected def translateToPlanInternal(
    ...
    val transformation = new OneInputTransformation(inputTransform, getRelDetailedDescription, getFlinkRelTypeName, operator, outRowType, inputTransform.getParallelism)
  ...
  private def createWindowOperator(
      ...
      timeIdx: Int,
      keyedStateTtlEnable: Boolean): WindowOperator[_, _] = {
    ...
    newBuilder.setStateRetentionTime(config.getMinIdleStateRetentionTime)
    newBuilder.enableStateTtl(keyedStateTtlEnable)
