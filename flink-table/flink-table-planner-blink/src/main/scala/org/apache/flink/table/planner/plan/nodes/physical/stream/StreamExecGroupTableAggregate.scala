...
class StreamExecGroupTableAggregate(
  ...
  override protected def translateToPlanInternal(
    ...
    val ret = new OneInputTransformation(inputTransformation, "GroupTableAggregate", getFlinkRelTypeName, operator, RowDataTypeInfo.of(outRowType), inputTransformation.getParallelism)
