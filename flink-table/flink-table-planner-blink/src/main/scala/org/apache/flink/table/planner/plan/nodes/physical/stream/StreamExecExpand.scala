...
class StreamExecExpand(
  ...
  override protected def translateToPlanInternal(
    ...
    val transform = new OneInputTransformation(inputTransform, getRelDetailedDescription, getFlinkRelTypeName, operator, RowDataTypeInfo.of(outputType), inputTransform.getParallelism)
