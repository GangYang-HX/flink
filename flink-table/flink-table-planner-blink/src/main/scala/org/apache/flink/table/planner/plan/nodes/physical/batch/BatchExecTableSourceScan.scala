...
class BatchExecTableSourceScan(
  ...
  override protected def createInputFormatTransformation(
    ...
    ExecNode.setManagedMemoryWeight(env.addSource(func, name, operatorType, outTypeInfo).getTransformation)
  }

  override protected def translateToPlanInternal(
      planner: BatchPlanner): Transformation[RowData] = {
    createSourceTransformation(planner.getExecEnv, getRelDetailedDescription, getFlinkRelTypeName)
  }
}
