...
//    }
    ...
    val ret = new OneInputTransformation(inputTransform, getRelDetailedDescription, getFlinkRelTypeName, substituteStreamOperator, RowDataTypeInfo.of(outputType), inputTransform.getParallelism)
