...
class StreamExecGlobalGroupAggregate(
  ...
  override protected def translateToPlanInternal(
    ...
    val ret = new OneInputTransformation(inputTransformation, getRelDetailedDescription, getFlinkRelTypeName, operator, RowDataTypeInfo.of(outRowType), inputTransformation.getParallelism)
