...
import org.apache.flink.table.runtime.dataview.ListViewSpecV2;
import org.apache.flink.table.runtime.dataview.MapViewSpecV2;
 ...
 * {@link DataViewSpecV2} contains all information necessary to store and retrieve data from state.
 */
@Internal
public final class DataViewUtils {

	/** Searches for data views in the data type of an accumulator and extracts them. */
	public static List<DataViewSpecV2> extractDataViews(int aggIndex, DataType accumulatorDataType) {
		...
		final List<DataViewSpecV2> specs = new ArrayList<>();
	...
	public static class DistinctViewSpec extends MapViewSpecV2 {
