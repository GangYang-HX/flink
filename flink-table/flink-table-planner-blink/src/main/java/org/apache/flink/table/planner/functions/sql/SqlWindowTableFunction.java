    ...
    protected abstract static class AbstractOperandMetadata implements SqlOperandMetadata {
        ...
        void validateColumnNames(
            ...
            for (SqlNode columnName : columnNames) {
                ...
                if (indexOf(fieldNames, name, matcher) < 0) {
        ...
        private int indexOf(Iterable<String> names, String name, SqlNameMatcher matcher) {
            return Iterables.indexOf(names, n -> matcher.matches(n, name));
        }
    }
}
