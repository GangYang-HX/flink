...
import org.apache.flink.table.runtime.keyselector.BinaryRowDataKeySelectorV2;
import org.apache.flink.table.runtime.keyselector.EmptyRowDataKeySelector;
import org.apache.flink.table.runtime.keyselector.EmptyRowDataKeySelectorV2;
...
public class KeySelectorUtil {
	 ...
	 * InternalTypeInfoV2} of {@link RowData}.
	 *
	 * @param keyFields key fields
	 * @param rowType type of DataStream to extract keys
	 ...
	 *     InternalTypeInfoV2} of {@link RowData}.
	 */
	public static RowDataKeySelectorV2 getRowDataSelectorV2(
			int[] keyFields, InternalTypeInfoV2<RowData> rowType) {
		if (keyFields.length > 0) {
			...
			GeneratedProjection generatedProjection =
					ProjectionCodeGenerator.generateProjection(
							...
							returnType,
							keyFields);
			InternalTypeInfoV2<RowData> keyRowType = InternalTypeInfoV2.of(returnType);
			return new BinaryRowDataKeySelectorV2(keyRowType, generatedProjection);
		} else {
			return EmptyRowDataKeySelectorV2.INSTANCE;
		}
	}
}
