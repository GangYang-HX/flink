...
public class RowTimeIntervalJoinTest extends TimeIntervalStreamJoinTestBase {
	...
	public void testRowTimeInnerJoinWithCommonBounds() throws Exception {
		IntervalJoinConfig config = new IntervalJoinConfig();
		config.setCleanUpInterval(15);

		RowTimeIntervalJoin joinProcessFunc = new RowTimeIntervalJoin(
				FlinkJoinType.INNER, -10, 20, 0, rowType, rowType, generatedFunction, 0, 0, config);
	...
	public void testRowTimeInnerJoinWithNegativeBounds() throws Exception {
		IntervalJoinConfig config = new IntervalJoinConfig();
		config.setCleanUpInterval(1);

		RowTimeIntervalJoin joinProcessFunc = new RowTimeIntervalJoin(
				FlinkJoinType.INNER, -10, -7, 0, rowType, rowType, generatedFunction, 0, 0, config);
	...
	public void testRowTimeLeftOuterJoin() throws Exception {
		IntervalJoinConfig config = new IntervalJoinConfig();
		config.setCleanUpInterval(7);

		RowTimeIntervalJoin joinProcessFunc = new RowTimeIntervalJoin(
				FlinkJoinType.LEFT, -5, 9, 0, rowType, rowType, generatedFunction, 0, 0, config);
	...
	public void testRowTimeRightOuterJoin() throws Exception {
		...
		RowTimeIntervalJoin joinProcessFunc = new RowTimeIntervalJoin(
				FlinkJoinType.RIGHT, -5, 9, 0, rowType, rowType, generatedFunction, 0, 0, config);
	...
	public void testRowTimeFullOuterJoin() throws Exception {
		...
		RowTimeIntervalJoin joinProcessFunc = new RowTimeIntervalJoin(
				FlinkJoinType.FULL, -5, 9, 0, rowType, rowType, generatedFunction, 0, 0, config);
