 ...
 */
@Internal
public final class InternalTypeInfoV2<T> extends TypeInformation<T> implements DataTypeQueryable {
	...
	public static <T> InternalTypeInfoV2<T> of(LogicalType type) {
		final Class<?> typeClass = LogicalTypeUtils.toInternalConversionClass(type);
		final TypeSerializer<?> serializer = InternalSerializers.createV2(type);
		return (InternalTypeInfoV2<T>) new InternalTypeInfoV2(type, typeClass, serializer);
	}

	/** Creates type information for a {@link RowType} represented by internal data structures. */
	public static InternalTypeInfoV2<RowData> of(RowType type) {
		return of((LogicalType) type);
	}

	/** Creates type information for {@link RowType} represented by internal data structures. */
	public static InternalTypeInfoV2<RowData> ofFields(LogicalType... fieldTypes) {
		return of(RowType.of(fieldTypes));
	}

	/** Creates type information for {@link RowType} represented by internal data structures. */
	public static InternalTypeInfoV2<RowData> ofFields(
	...
	public boolean equals(Object o) {
		...
		final InternalTypeInfoV2<?> that = (InternalTypeInfoV2<?>) o;
	...
	public boolean canEqual(Object obj) {
		return obj instanceof InternalTypeInfoV2;
	}
}
