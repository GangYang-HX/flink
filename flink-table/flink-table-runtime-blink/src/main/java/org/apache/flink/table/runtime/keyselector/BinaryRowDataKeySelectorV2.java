...
public class BinaryRowDataKeySelectorV2 implements RowDataKeySelectorV2 {

	private static final long serialVersionUID = 5375355285015381919L;

	private final InternalTypeInfoV2<RowData> keyRowType;
	private final GeneratedProjection generatedProjection;
	private transient Projection<RowData, BinaryRowData> projection;

	public BinaryRowDataKeySelectorV2(
			InternalTypeInfoV2<RowData> keyRowType, GeneratedProjection generatedProjection) {
