 ...
 */
public final class RowTimeLatencyJoin extends TimeLatencyJoin {
	...
	public RowTimeLatencyJoin(
		...
		super(joinType, leftLowerBound, leftUpperBound, allowedLateness, leftType, rightType, genJoinFunc, joinConfig);
