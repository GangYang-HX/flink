...
public class WatermarkAssignerOperator
	...
	public void open() throws Exception {
		...
		this.deliverUpstreamWatermarkEnabled = getExecutionConfig().isDeliverUpstreamWatermarkEnabled();
	...
	public void processWatermark(Watermark mark) throws Exception {
		// If we receive a Long.MAX_VALUE watermark or using watermark from up stream, we will forward it.
