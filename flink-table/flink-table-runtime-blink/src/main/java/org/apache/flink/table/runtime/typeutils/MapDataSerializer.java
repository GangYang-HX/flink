...
public class MapDataSerializer extends TypeSerializer<MapData> {
	...
	public MapDataSerializer(LogicalType keyType, LogicalType valueType) {
		this(
				keyType,
				valueType,
				org.apache.flink.table.runtime.typeutils.InternalSerializers.create(keyType),
				org.apache.flink.table.runtime.typeutils.InternalSerializers.create(valueType));
	}
