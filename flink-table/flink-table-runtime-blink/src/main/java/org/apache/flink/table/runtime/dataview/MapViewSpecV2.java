...
@Internal
public class MapViewSpecV2 extends DataViewSpecV2 {
	...
	public MapViewSpecV2(String stateId, int fieldIndex, DataType dataType, boolean containsNullKey) {
		this(stateId, fieldIndex, dataType, containsNullKey, null, null);
	}

	@Deprecated
	public MapViewSpecV2(
		String stateId,
		int fieldIndex,
		DataType dataType,
