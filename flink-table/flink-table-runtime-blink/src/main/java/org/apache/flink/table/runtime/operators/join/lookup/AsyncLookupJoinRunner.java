...
import static org.apache.flink.table.api.config.ExecutionConfigOptions.TABLE_EXEC_ASYNC_LOOKUP_BUFFER_CAPACITY;
...
public class AsyncLookupJoinRunner extends RichAsyncFunction<RowData, RowData> {
	...
	public void open(Configuration parameters) throws Exception {
		...
		getRuntimeContext().getExecutionConfig().getGlobalJobParameters().toMap().put(TABLE_EXEC_ASYNC_LOOKUP_BUFFER_CAPACITY.key(), String.valueOf(asyncBufferCapacity));
