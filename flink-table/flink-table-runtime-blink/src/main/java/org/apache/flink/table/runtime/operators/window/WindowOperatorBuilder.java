...
public class WindowOperatorBuilder {
	...
	protected long stateRetentionTime = 0L;
	protected boolean produceUpdates = false;
	protected int rowtimeIndex = -1;
	private boolean enableStateTtl;
	...
	public void enableStateTtl(boolean enableStateTtl){
		this.enableStateTtl = enableStateTtl;
	}

	public void setStateRetentionTime(long stateRetentionTime) {
		...
		public WindowOperator build() {
			...
			if (generatedTableAggregateFunction != null) {
				...
				return new TableAggregateWindowOperator(
					...
					windowOperatorBuilder.enableStateTtl);
			} else {
				//noinspection unchecked
				return new TableAggregateWindowOperator(
