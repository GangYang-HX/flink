...
//		final String sql = "select a.a, b.b from emp a  \n"
//			+ " join dept FOR SYSTEM_TIME AS OF now() as b on a.deptno = b.deptno";
    final String sql = "select a.a, b.b from emp a  \n"
        + " join dept DELAY AS OF '50' second window and '30' second delay as b on a.deptno = b.deptno";
		SqlParser parser = createFlinkParser(sql);
		parser.parseStmt();
	}
