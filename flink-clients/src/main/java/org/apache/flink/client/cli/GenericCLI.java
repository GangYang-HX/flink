...
public class GenericCLI implements CustomCommandLine {
	...
	public Configuration applyCommandLineOptionsToConfiguration(final CommandLine commandLine) {
		...
		if (executorName != null) {
			...
			effectiveConfiguration.setString(DeploymentOptions.CLUSTER_TYPE, executorName);
		}
		...
		if (targetName != null) {
			...
			effectiveConfiguration.setString(DeploymentOptions.CLUSTER_TYPE, targetName);
		}
