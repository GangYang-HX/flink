...
/**
 * more info could see https://info.bilibili.co/pages/viewpage.action?pageId=342271942
 * @author: zhuzhengjun
...
public class DataFormatUtils {
	...
	/**
	 * attention: bizType must equals with created job's biz type ,otherwise may cause create repeated dummy job
	...
	public static String getInstanceByUidQueryData(String relateUID, String bizStartTime, String bizEndTime, String opUser) {
