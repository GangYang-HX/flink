...
public class TraceUtils {
    ...
    public static <T> long parseTimestamp(Map<String, String> headers, int recordType, T record) {
        if (recordType == RecordType.LANCER_RECORD.recordType) {
            ...
            if (record instanceof ProducerRecord) {
                return ((ProducerRecord) record).timestamp();
            } else {
                return ((ConsumerRecord) record).timestamp();
            }
        } else {
