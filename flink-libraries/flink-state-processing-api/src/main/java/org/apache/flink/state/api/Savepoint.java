...
public final class Savepoint {
	...
	public static NewSavepoint create(StateBackend stateBackend, int maxParallelism) {
		...
		return create(new SavepointMetadata(maxParallelism, Collections.emptyList(), Collections.emptyList()), stateBackend);
	}

	/**
	 * Creates a new savepoint.
	 * @param savepointMetadata The savepointMetadata that the creation base on.
	 * @param stateBackend The state backend of the savepoint used for keyed state.
	 * @return A new savepoint.
	 */
	public static NewSavepoint create(SavepointMetadata savepointMetadata, StateBackend stateBackend) {
		return new NewSavepoint(savepointMetadata, stateBackend);
	}
}
