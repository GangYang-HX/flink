 ...
 *
 * <p>For every key is invoked. This can produce zero or more
 * elements with raw state as output.
 *
 * @param <K> Type of the keys
 * @param <OUT> Type of the output elements.
 */
@PublicEvolving
public abstract class RawKeyedStateReaderFunction<K, OUT> extends AbstractRichFunction {
	...
	public abstract void readKey(K deserializedKey, byte[] key, String stateName, byte[] value, Context ctx, Collector<OUT> out) throws Exception;
