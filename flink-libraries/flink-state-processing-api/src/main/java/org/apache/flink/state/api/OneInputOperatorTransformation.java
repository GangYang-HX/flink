...
public class OneInputOperatorTransformation<T> {
	 ...
	 * @return The {@code BootstrapTransformation} with partitioned state.
	 */
	public <K> KeyedOperatorTransformation<K, T> keyBy(KeySelector keySelector, TypeInformation<K> keyType) {
		return new KeyedOperatorTransformation<>(dataSet, operatorMaxParallelism, keySelector, keyType);
	}
	 ...
	 * @return The {@code BootstrapTransformation} with partitioned state.
	 */
	public <K> KeyedOperatorTransformation<K, T> keyBy(KeySelector keySelector, TypeSerializer keySerializer) {
		return new KeyedOperatorTransformation<>(dataSet, operatorMaxParallelism, keySelector, keySerializer);
	}
