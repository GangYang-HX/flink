...
public class TimeOutFuture {
	...
	private RedisRowDataLookupFunction.Outputer redisRowDataOutputer;
	...
	public TimeOutFuture(KeyGenerator keyGenerator, RedisFuture futureForValue , RedisRowDataLookupFunction.Outputer redisRowDataOutputer, CompletableFuture<Collection<RowData>> resultFuture, Object queryKey, long time ,int retry) {
	...
	public RedisRowDataLookupFunction.Outputer getRedisRowDataOutputer() {
	...
	public String toString() {
		return "TimeOutFuture{" +
			...
			", redisRowDataOutputer=" + redisRowDataOutputer +
			", keyGenerator=" + keyGenerator +
			", futureForValue=" + futureForValue +
			", retry=" + retry +
			", timeout=" + timeout +
			'}';
	}
