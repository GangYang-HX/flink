...
public class MyselfTest {
    ...
    public void myTest() throws Exception {
        ...
        final String source ="CREATE TABLE t_student (\n"
                + "\tid INT,\n"
                + "\tname STRING\n"
                + ") WITH (\n"
                + "\t'connector' = 'kafka',\n"
    ...
    public void consumeAndSink() throws Exception {
        ...
        String insertSQL = "insert into sink(urn,aspect,properties,action) select urn,aspect,properties,action from source";
