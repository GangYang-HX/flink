...
import com.bilibili.bsql.kafka.util.TraceUtils;
...
public class RetryDynamicKafkaRecordSerializationSchema
    ...
    public RetryDynamicKafkaRecordSerializationSchema(
        ...
        this.traceId = this.userDefinedProps.getOrDefault(SINK_TRACE_ID.key(), "").toString();
        this.traceKind =
                this.userDefinedProps
                        .getOrDefault(SINK_TRACE_KIND.key(), SINK_TRACE_KIND.defaultValue())
                        .toString();
        this.traceClass =
                this.userDefinedProps
                        .getOrDefault(
                                SINK_CUSTOM_TRACE_CLASS.key(),
                                SINK_CUSTOM_TRACE_CLASS.defaultValue())
                        .toString();
    }
