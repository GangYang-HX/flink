 ...
 */
@PublicEvolving
public class RetryKafkaSinkBuilder<IN> {
    private static final Logger LOG = LoggerFactory.getLogger(RetryKafkaSinkBuilder.class);
    ...
    protected Properties kafkaProducerConfig;
     ...
     */
    public RetryKafkaSinkBuilder<IN> setDeliverGuarantee(DeliveryGuarantee deliveryGuarantee) {
     ...
     * @return {@link org.apache.flink.connector.kafka.sink.KafkaSinkBuilder}
     */
    public RetryKafkaSinkBuilder<IN> setKafkaProducerConfig(Properties kafkaProducerConfig) {
     ...
     * @return {@link org.apache.flink.connector.kafka.sink.KafkaSinkBuilder}
     */
    public RetryKafkaSinkBuilder<IN> setUserDefinedProps(Properties userDefinedProps) {
        this.userDefinedProps = checkNotNull(userDefinedProps, "userDefinedProps");
        return this;
    }
     ...
     * @return {@link org.apache.flink.connector.kafka.sink.KafkaSinkBuilder}
     */
    public RetryKafkaSinkBuilder<IN> setRecordSerializer(
    ...
    public RetryKafkaSinkBuilder<IN> setPartitoner(FlinkKafkaPartitioner<IN> partitioner) {
        this.partitioner = checkNotNull(partitioner, "partitioner");
        return this;
    }

    public RetryKafkaSinkBuilder<IN> setRetry(Boolean retry) {
        this.retry = retry;
        return this;
    }

    public RetryKafkaSinkBuilder<IN> setPendingRetryRecordsLimit(Integer pendingRetryRecordsLimit) {
     ...
     * @return {@link org.apache.flink.connector.kafka.sink.KafkaSinkBuilder}
     */
    public RetryKafkaSinkBuilder<IN> setTransactionalIdPrefix(String transactionalIdPrefix) {
     ...
     * @return {@link org.apache.flink.connector.kafka.sink.KafkaSinkBuilder}
     */
    public RetryKafkaSinkBuilder<IN> setBootstrapServers(String bootstrapServers) {
