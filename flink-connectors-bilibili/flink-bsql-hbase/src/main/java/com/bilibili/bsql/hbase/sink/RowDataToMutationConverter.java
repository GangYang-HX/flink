...
public class RowDataToMutationConverter implements HBaseMutationConverter<RowData> {
	...
	public RowDataToMutationConverter(HBaseTableSchema schema, final String nullStringLiteral, Boolean skipWAL,
	...
	@Override
	public void open() {
		this.serde = new HBaseSerde(schema, nullStringLiteral, skipWAL, versionRowIdx, versionColIdx, versionDataType);
	}
