...
import com.bilibili.bsql.hbase.util.HBaseConfigurationUtil;
...
public class HBaseSinkFunction<T>
		extends CustomizeRichSinkFunction<T>
	...
	@Override
	public boolean doInvoke(T value, Context context) throws Exception {
