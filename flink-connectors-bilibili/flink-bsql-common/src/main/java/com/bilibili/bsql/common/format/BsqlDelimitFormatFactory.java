...
import com.bilibili.bsql.common.format.byterow.ByteRowDeserialization;
import com.bilibili.bsql.common.format.byterow.LancerByteRowDeserialization;
import com.bilibili.bsql.common.format.raw.LancerCustomDelimiterRawDeserialization;
...
import static com.bilibili.bsql.common.format.BsqlDelimitConfig.*;
import static org.apache.flink.table.utils.SaberStringUtils.unicodeStringDecode;


/**
 * Format factory for providing configured instances of delimit to RowData {@link SerializationSchema}
 * and {@link DeserializationSchema}.
 */
public final class BsqlDelimitFormatFactory implements
			...
			public DeserializationSchema<RowData> createRuntimeDecoder(
				...
				if (useLancerFormat){
					if (FORMAT_BYTES.equals(format)) {
						return new LancerByteRowDeserialization(rowDataTypeInfo, rowType, delimitString, lancerSinkDest, traceId);
					} else {
						return new LancerCustomDelimiterRawDeserialization(rowDataTypeInfo, rowType, delimitString,
								lancerSinkDest, traceId, useLancerDebug);
					}
				...
				return useRawFormat ?
					new CustomDelimiterRawDeserialization(rowDataTypeInfo, rowType, delimitString) :
					new CustomOtherDelimiterDeserialization(rowDataTypeInfo, rowType, delimitString, noDefaultValue);
			}
