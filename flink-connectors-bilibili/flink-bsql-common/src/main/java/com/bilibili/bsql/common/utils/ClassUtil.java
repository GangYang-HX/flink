...
public class ClassUtil {
	 ...
	 * <code>java.lang.Long</code> 和 <code>java.lang.Character</code> 。如果满足这个条件，则返回 <code>true</code>。</li>
	...
	public static Class<?> stringConvertClass(String str) {
		switch (str.toLowerCase()) {
			...
			case "clickintarray":
				return ClickIntArray.class;

			case "clickfloatarray":
				return ClickFloatArray.class;

			case "clickstringarray":
				return ClickStringArray.class;
	 ...
	 * @return
	 */
	public static Class<?> stringConvertBizClass(LogicalType type) {
		/*case "array":
		return Byte[].class;
		...
		throw new RuntimeException("不支持 " + type.toString() + " 类型");
	}
