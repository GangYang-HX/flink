package com.bilibili.bsql.common.converter;
...
import com.bilibili.bsql.common.utils.ObjectUtils;
...
public class CustomRowConverter implements Serializable {
    ...
    private Boolean noDefaultValue = false;
    ...
    private Object getDefaultValue(LogicalType type) {
        return this.noDefaultValue ? null : ObjectUtils.getDefaultValue(type);
    }
