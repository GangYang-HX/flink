...
import com.bilibili.bsql.hive.filetype.parquet.GenericRecordConverter;
...
/**
 * Avro implementation of {@link WriteSupport} for generic, specific, and reflect models. Use {@link AvroParquetWriter}
 * or {@link AvroParquetOutputFormat} rather than using this class directly.
 */
public class BiliAvroWriteSupport extends WriteSupport<Row> {
     ...
     */
    @Deprecated
    public BiliAvroWriteSupport(MessageType schema, Schema avroSchema) {
    ...
    public BiliAvroWriteSupport(MessageType schema, Schema avroSchema, GenericData model) {
        this.rootSchema = schema;
        this.rootAvroSchema = avroSchema;
        this.rootLogicalType = rootAvroSchema.getLogicalType();
        this.model = model;
     ...
     * @see AvroParquetOutputFormat#setSchema(org.apache.hadoop.mapreduce.Job, Schema)
     */
    ...
    public WriteContext init(Configuration configuration) {
        ...
        converter = new GenericRecordConverter(rootAvroSchema);

        Map<String, String> extraMetaData = new HashMap<String, String>();
        extraMetaData.put(AVRO_SCHEMA_METADATA_KEY, rootAvroSchema.toString());
        ...
        public void writeJavaArray(GroupType schema, Schema avroSchema, Class<?> arrayClass, Object value) {
            ...
            switch (avroSchema.getElementType().getType()) {
                ...
                case DOUBLE:
                    ...
                    break;
                default:
                    throw new IllegalArgumentException("Cannot write " + avroSchema.getElementType() + " array: "
                            + arrayClass.getName());
            }
        }
