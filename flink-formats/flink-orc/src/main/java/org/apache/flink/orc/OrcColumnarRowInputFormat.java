...
public class OrcColumnarRowInputFormat<BatchT, SplitT extends FileSourceSplit>
    ...
    private static final Logger LOG = LoggerFactory.getLogger(OrcColumnarRowInputFormat.class);
        ...
        ColumnBatchFactory<VectorizedRowBatch, SplitT> batchGenerator =
                (SplitT split, VectorizedRowBatch rowBatch) -> {
                    ...
                    for (int i = 0; i < vectors.length; i++) {
                        ...
                        ColumnVector vector = partitionKeys.contains(name)
                        ...
                        LOG.info("VectorizedColumnBatch created,columnName={},type={}, vector={}",
                                name,
                                type,
                                vector);
                        vectors[i] = vector;
