...
public class PipelineOptions {
    ...
    public static final ConfigOption<Boolean> INHERIT_SLOT_GROUP =
            key("pipeline.inherit-slot-group")
                    .booleanType()
                    .defaultValue(true)
                    .withDescription("if true, when no slot group is set, use the input slot group, else use the " +
                            "default as slot group");
	...
	public static final ConfigOption<Boolean> USE_SOURCE_PARTITION_AS_PARALLELISM =
		key("pipeline.use-source-partition-as-parallelism")
			.booleanType()
			.defaultValue(true)
			.withDescription("Use the number of source partition as source operator parallelism. " +
	...
	public static final ConfigOption<Boolean> FORCE_REBALANCE =
			key("pipeline.force-rebalance")
					.booleanType()
					.defaultValue(false)
					.withDescription("Use rebalance between the source stream node and its next data stream, " +
	...
	public static final ConfigOption<Boolean> FORCE_RESCALE =
		key("pipeline.force-rescale")
			.booleanType()
			.defaultValue(false)
			.withDescription("Use rescale between the source stream node and its next data stream, " +
	...
	public static final ConfigOption<Boolean> FORCE_FORWARD =
		key("pipeline.force-forward")
			.booleanType()
			.defaultValue(false)
			.withDescription("Use forward between the source stream node and its next data stream, " +
