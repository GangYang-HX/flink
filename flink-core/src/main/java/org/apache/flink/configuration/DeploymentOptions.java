...
public class DeploymentOptions {
	...
	public static final ConfigOption<String> CLUSTER_TYPE =
		key("cluster.type")
			.stringType()
			.noDefaultValue()
			.withDescription("The deployment cluster type, e.g. k8s 、yarn");

	public static final ConfigOption<String> KUBERNETES_CLUSTER_ID =
		key("kubernetes.cluster-id")
			.stringType()
			.noDefaultValue()
			.withDescription("The deployment cluster id");
	...
	public static final ConfigOption<String> YARN_APPLICATION_QUEUE =
		key("yarn.application.queue")
			.stringType()
			.noDefaultValue()
			.withDescription("The deployment yarn queue name");
