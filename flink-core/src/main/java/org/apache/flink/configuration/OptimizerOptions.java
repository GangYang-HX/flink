...
public class OptimizerOptions {
	...
	public static final ConfigOption<Boolean> SCAN_SOURCE_PROJECT_PUSH_DOWN =
		key("table.optimizer.source.project.push.down")
			.defaultValue(false)
			.withDescription("SourceScanTable Project push down.");
