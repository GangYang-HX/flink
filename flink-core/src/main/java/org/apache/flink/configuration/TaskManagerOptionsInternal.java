...
public class TaskManagerOptionsInternal {
    ...
    /**
     * The ID of the node where the task manager is located on. In Yarn and Native Kubernetes mode,
     * this option will be set by the resource manager when launching a container for the task
     * executor. In other modes, this option will not be set. This option is only used internally.
     */
